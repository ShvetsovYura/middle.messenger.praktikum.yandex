                ...
                <li class="chat-item {{#if selected}} chat-item_selected {{/if}}">
                    ...
                    <div class="chat-item__user-caption">
                        ...
                        <p class="chat-item__dialog-subtitle">
                            ...
                            <span
                                class="chat-item__unread_badge {{#if (isdefined unreadCount)}} hide{{/if}}">{{unreadCount}}</span>
                        </p>
                    </div>
                </li>
            {{/each }}
        ...
        <div class="chat-messages-panel">
            ...
            <div class="chat-messages-container">
                ...
                <div class="chat-message {{#if own}} chat-message_own {{/if}}">
                    <div
                        class="chat-message__body {{#if own}} chat-message__body_own {{else}} chat-message__body_partner {{/if}}">
