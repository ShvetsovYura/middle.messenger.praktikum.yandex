...
<form class="form form_small">
  <h2 class="form-header">Регистрация пользователя</h2>
  <div class="form-field">
    ...
    <input
      ...
      requiredF
    />
    <span class="form-field__validation-message"> Поле не может быть пустым </span>
  </div>
  <div class="form-field">
  ...
  <div class="form-field">
    ...
    <input
      ...
      required
    />
    <span class="form-field__validation-message form-field__validation-message_hide"> Пароли не совпадают </span>
  </div>
  <div class="form-field">
    <button class="form-field__submit" type="submit">Зарегистрироваться</button>
  </div>
  <div>
