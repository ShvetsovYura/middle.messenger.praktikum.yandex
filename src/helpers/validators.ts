...
export const firstNameValidator = new Validator().addRule(longerThan(1)).addRule(onlyCyrilicLetters());
export const displayNameValidator = new Validator().addRule(latinOrCyrilicLetters()).addRule(longerThan(3));
